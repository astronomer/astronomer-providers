...
def test_bigquery_trigger_serialization():
    ...
    assert classpath == "astronomer.operators.google.cloud.triggers.bigquery.BigQueryInsertJobTrigger"
    assert kwargs == {
...
@pytest.mark.asyncio
@mock.patch("astronomer.operators.google.cloud.hooks.bigquery.BigQueryHookAsync.get_job_status")
