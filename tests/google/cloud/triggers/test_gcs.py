...
def test_gcs_trigger_serialization():
    ...
    assert classpath == "astronomer.operators.google.cloud.triggers.gcs.GCSBlobTrigger"
    assert kwargs == {
        "bucket": TEST_BUCKET,
...
@pytest.mark.asyncio
@mock.patch("astronomer.operators.google.cloud.triggers.gcs.GCSBlobTrigger._object_exists")
