...
from astronomer.operators.google.cloud.hooks.bigquery import (
    BigQueryHookAsync,
    _BigQueryHook,
)
...
class TestBigQueryHookMethods(_BigQueryBaseTestClass):
    ...
    @mock.patch("astronomer.operators.google.cloud.hooks.bigquery.QueryJob")
    @mock.patch("astronomer.operators.google.cloud.hooks.bigquery._BigQueryHook.get_client")
...
@pytest.mark.asyncio
@mock.patch("astronomer.operators.google.cloud.hooks.bigquery.Session")
...
@pytest.mark.asyncio
@mock.patch("astronomer.operators.google.cloud.hooks.bigquery.BigQueryHookAsync.get_job_instance")
@mock.patch("astronomer.operators.google.cloud.hooks.bigquery.Session")
