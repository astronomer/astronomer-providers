...
class TestBigQueryHookAsync:
    ...
    @mock.patch("astronomer.providers.google.cloud.hooks.bigquery.ClientSession")
    async def test_get_job_status_success(self, mock_session, mock_job_instance):
        hook = BigQueryHookAsync()
    ...
    @mock.patch("astronomer.providers.google.cloud.hooks.bigquery.BigQueryHookAsync.get_job_instance")
    @mock.patch("astronomer.providers.google.cloud.hooks.bigquery.ClientSession")
    async def test_get_job_output_assert_once_with(self, mock_session, mock_job_instance):
        hook = BigQueryHookAsync()
    ...
    def test_value_check_success(self, records, pass_value, tolerance):
        ...
        assert hook.value_check(query, pass_value, records, tolerance) is None
