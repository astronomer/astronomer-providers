...
class TestEmrContainerHookAsync:
    @pytest.mark.asyncio
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrContainerHookAsync.get_client_async")
    async def test_emr_container_cluster_exception(self, mock_client):
        """Test check_job_status async hook function to get the status of the job running in emr container
        using Aiobotocore lib"""
        # mocking async context function with return_value of __aenter__
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrContainerHookAsync.get_client_async")
    async def test_get_job_failure_reason_key_error(self, mock_client):
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrContainerHookAsync.get_client_async")
    async def test_get_job_failure_reason_exception(self, mock_client):
...
class TestEmrStepSensorHookAsync:
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrStepSensorHookAsync.get_client_async")
    async def test_emr_describe_step_failed(self, mock_client):
    ...
    def test_state_from_response(self, state):
    ...
    def test_failure_message_from_response(self):
...
class TestEmrJobFlowHookAsync:
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrJobFlowHookAsync.get_client_async")
    async def test_emr_job_flow_cluster_status(self, mock_client):
        """
        Test get_cluster_details async hook function to get the details of the cluster
        and job running in emr cluster using Aiobotocore lib
        """
        mock_result = {
            "Cluster": {
                "Id": "j-336EWEPYOZKOD",
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrJobFlowHookAsync.get_client_async")
    async def test_emr_job_flow_get_cluster_details_exception(self, mock_client):
    ...
    def test_job_flow_state_from_response(self):
        """Assert state_from_response function response"""
        response = {
            "Cluster": {
                "Id": "j-336EWEPYOZKOD",
    ...
    def test_job_flow_failure_message_from_response(self):
        """Assert failure_message_from_response function response"""
        response = {
            "Cluster": {
                "Id": "j-336EWEPYOZKOD",
    ...
    def test_job_flow_failure_message_from_response_without_state_change(self):
        """Assert failure_message_from_response function response"""
        response = {
            "Cluster": {
                "Id": "j-336EWEPYOZKOD",
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.emr.EmrContainerHookAsync.get_client_async")
    async def test_get_job_failure_reason_success(self, mock_client):
