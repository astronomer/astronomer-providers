...
def test_s3_key_trigger_serialization():
    ...
    assert classpath == "astronomer.operators.amazon.aws.triggers.s3.S3KeyTrigger"
    assert kwargs == {
...
@pytest.mark.asyncio
@mock.patch("astronomer.operators.amazon.aws.triggers.s3.S3HookAsync.get_client_async")
@mock.patch("astronomer.operators.amazon.aws.triggers.s3.S3KeyTrigger._check_key")
...
@mock.patch("astronomer.operators.amazon.aws.triggers.s3.S3HookAsync.get_client_async")
@mock.patch("astronomer.operators.amazon.aws.triggers.s3.S3KeyTrigger._check_exact_key")
@mock.patch("astronomer.operators.amazon.aws.triggers.s3.S3KeyTrigger._check_wildcard_key")
@pytest.mark.asyncio
