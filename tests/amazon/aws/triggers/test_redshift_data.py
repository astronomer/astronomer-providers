...
class TestRedshiftDataTrigger:
    ...
    async def test_redshift_data_trigger_run(self, mock_get_query_status, query_ids, return_value, response):
        """
    ...
    @mock.patch("astronomer.providers.amazon.aws.hooks.redshift_data.RedshiftDataHook.get_query_status")
    async def test_redshift_data_trigger_exception(self, mock_get_query_status, query_ids):
        """
