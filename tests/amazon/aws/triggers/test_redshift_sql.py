...
class TestRedshiftSQLTrigger:
    def test_redshift_sql_trigger_serialization(self):
        """
    ...
    async def test_redshiftsql_trigger_run(self, mock_get_query_status, query_ids, return_value, response):
        """
    ...
    @mock.patch("astronomer.providers.amazon.aws.hooks.redshift_sql.RedshiftSQLHookAsync.get_query_status")
    async def test_redshiftsql_trigger_exception(self, mock_get_query_status, query_ids):
        """
