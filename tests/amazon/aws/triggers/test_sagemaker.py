...
def test_sagemakerprocessing_trigger_serialization():
    """
...
async def test_sagemakerprocessing_trigger_success(mock_processing_job):
    """
...
async def test_sagemakerprocessing_trigger_failed(mock_processing_job):
    """
...
@pytest.mark.asyncio
@mock.patch.object(
    SageMakerHookAsync, "describe_processing_job_async", return_value={"ProcessingJobStatus": "InProgress"}
)
async def test_sagemakerprocessing_trigger_pending(mock_processing_job):
...
async def test_sagemakerprocessing_trigger_timeout(mock_processing_job):
...
async def test_sagemakerprocessing_trigger_exception(mock_processing_job):
