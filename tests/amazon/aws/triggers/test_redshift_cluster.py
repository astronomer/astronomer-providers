...
class TestRedshiftClusterTrigger:
    ...
    async def test_redshift_cluster_delete_trigger_run(
        self, mock_delete_cluster, operation_type, return_value, response
    ):
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.redshift_cluster.RedshiftHookAsync.delete_cluster")
    async def test_redshift_cluster_delete_trigger_failure(self, mock_delete_cluster):
    ...
    def test_redshift_cluster_resume_trigger_serialization(self):
        """
        Asserts that the RedshiftClusterTrigger correctly serializes its arguments
        and classpath.
        """
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.redshift_cluster.RedshiftHookAsync.resume_cluster")
    async def test_redshift_cluster_resume_trigger_failure(self, mock_resume_cluster):
    ...
    def test_redshift_pause_resume_trigger_serialization(self):
        """
        Asserts that the RedshiftClusterTrigger correctly serializes its arguments
        and classpath.
        """
    ...
    async def test_redshift_cluster_pause_trigger_run(
    ...
    @pytest.mark.asyncio
    @mock.patch("astronomer.providers.amazon.aws.hooks.redshift_cluster.RedshiftHookAsync.pause_cluster")
    async def test_redshift_cluster_pause_trigger_failure(self, mock_pause_cluster):
