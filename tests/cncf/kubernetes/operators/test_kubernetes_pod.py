...
from astronomer.operators.cncf.kubernetes.operators.kubernetes_pod import (
...
@mock.patch(
    "astronomer.operators.cncf.kubernetes.operators.kubernetes_pod.KubernetesPodOperatorAsync.cleanup"
)
@mock.patch("airflow.kubernetes.kube_client.get_kube_client")
@mock.patch(
    "astronomer.operators.cncf.kubernetes.operators.kubernetes_pod.KubernetesPodOperatorAsync.raise_for_trigger_status"
)
@mock.patch(
    "astronomer.operators.cncf.kubernetes.operators.kubernetes_pod.KubernetesPodOperatorAsync.find_pod"
)
