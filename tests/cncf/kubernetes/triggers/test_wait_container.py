...
class TestWaitContainerTrigger:
    ...
    async def test_pending_timeout(self, load_kube_config):
    ...
    @mock.patch("kubernetes_asyncio.config.load_kube_config")
    async def test_other_exception(self, load_kube_config, read_mock):
    ...
    @mock.patch("kubernetes_asyncio.config.load_kube_config")
    async def test_pending_succeeded(self, load_kube_config, wait_completion):
        """
    ...
    @mock.patch(f"{TRIGGER_CLASS}.wait_for_container_completion")
    @mock.patch("kubernetes_asyncio.config.load_kube_config")
    async def test_pending_running(self, load_kube_config, wait_completion):
        """
    ...
    @mock.patch(f"{TRIGGER_CLASS}.wait_for_container_completion")
    @mock.patch("kubernetes_asyncio.config.load_kube_config")
    async def test_failed(self, load_kube_config, wait_completion):
        """
