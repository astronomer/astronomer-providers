...
from astronomer.operators.core.triggers.external_task import TaskStateTrigger
...
def test_task_state_trigger_serialization():
    ...
    assert classpath == "astronomer.operators.core.triggers.external_task.TaskStateTrigger"
    assert kwargs == {
        "dag_id": TEST_DAG_ID,
