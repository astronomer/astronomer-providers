...
from astronomer.operators.core.triggers.external_task import DagStateTrigger
...
def test_task_dag_trigger_serialization():
    ...
    assert classpath == "astronomer.operators.core.triggers.external_dag.DagStateTrigger"
    assert kwargs == {
        "dag_id": TEST_DAG_ID,
        "states": TEST_STATES,
