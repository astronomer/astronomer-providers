...
class TestHivePartitionTrigger:
    ...
    async def test_hive_partition_trigger_success(self, mock_get_connection, mock_partition_exists):
    ...
    @mock.patch("astronomer.providers.apache.hive.hooks.hive.HiveCliHookAsync.partition_exists")
    @mock.patch("astronomer.providers.apache.hive.hooks.hive.HiveCliHookAsync.get_connection")
    async def test_hive_partition_trigger_pending(self, mock_get_connection, mock_partition_exists):
    ...
    @mock.patch("astronomer.providers.apache.hive.hooks.hive.HiveCliHookAsync.partition_exists")
    @mock.patch("astronomer.providers.apache.hive.hooks.hive.HiveCliHookAsync.get_connection")
    async def test_hive_partition_trigger_exception(self, mock_get_connection, mock_partition_exists):
